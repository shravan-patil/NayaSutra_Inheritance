...
export const LawyerReviewVault = () => {
  ...
  const fetchLawyerEvidence = async () => {
    if (!profile?.id) return;

    setLoading(true);
    try {
      // Fetch only PENDING and REJECTED evidence uploaded by this lawyer
      ...
      console.error('Error fetching lawyer evidence:', error);
